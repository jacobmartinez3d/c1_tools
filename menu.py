...
def open_shotBrowser():
    nukescripts.panels.registerWidgetAsPanel(
        'c1_shotBrowser.ShotBrowser', 'C1 Shot Browser', 'c1_shotBrowser', True).addToPane(nuke.getPaneFor('Properties.1'))
...
def c1_timeline():
    c1_tools.c1_timeline(nuke.getFilename('Select Timeline file...'))

# _menu____________________________________________________________________
nuke.menu('Nuke').addCommand('C1 Tools/C1 Shot Browser',
                             'open_shotBrowser()', icon='sb.png')
nuke.menu('Nuke').addCommand('C1 Tools/C1 Submit Shot',
                             'c1_tools.submitShot(nuke.root().name())', icon='submitShot.png')
nuke.menu('Nuke').addCommand('C1 Tools/C1 Version Up',
                             'c1_tools.versionUp(nuke.root().name())', icon='versionUp.png')
...
nuke.menu('Nuke').addCommand(
    'C1 Tools/Convert Prores to mp4', 'c1_tools.proresToMp4()')
nuke.menu('Nuke').addCommand(
